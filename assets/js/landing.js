document.addEventListener("DOMContentLoaded", () => {
    ...
    const scenarioTexts = {
        en: `
            ...
            <p>In this part of the study, we would like you to imagine a specific situation. You will be asked to manage data sharing policies based on the following story:</p>

            <p><strong>The Story:</strong><br>
            Your mother, <strong>Jane Doe</strong>, recently fell and broke her feet. She is staying at an elderly care facility until she recovers, but you have now decided that she will stay there permanently. Because she finds digital management difficult, Jane has asked you, <strong>Alie Smith</strong>, to make sure all her data access is set up correctly.</p>

            <p>At the same time, you (<strong>Alie Smith</strong>) are moving out of your rental home and back into your childhood home (where Jane used to live) to save on rent and be closer to her.</p>
            ...
            On the next screens, you will see a tool designed to manage these rules. You will be given several tasks to complete as <strong>Alie Smith</strong>, managing both your own data and the data <strong>Jane Doe</strong> has shared with you.</p>

            <p>Please try to complete the tasks as accurately as possible. Remember, we are <strong>testing the tool</strong>, not you. If something feels confusing or difficult, that is a very important result for my research!</p>
        `,
        nl: `
            ...
            Uw moeder, <strong>Jane Doe</strong>, is onlangs gevallen en heeft haar voeten gebroken. Ze verblijft momenteel in een zorginstelling om te herstellen, maar u heeft inmiddels besloten dat ze daar permanent zal blijven wonen. Omdat zij digitaal beheer lastig vindt, heeft Jane aan u, <strong>Alie Smith</strong>, gevraagd om ervoor te zorgen dat alle toegang tot haar gegevens correct is ingesteld.</p>

            <p>Tegelijkertijd gaat u (<strong>Alie Smith</strong>) verhuizen van uw huurwoning naar uw ouderlijk huis (waar Jane voorheen woonde) om huur te besparen en dichter bij haar te zijn.</p>
            ...
            Op de volgende schermen ziet u een tool die ontworpen is om deze regels te beheren. U krijgt verschillende taken die u moet uitvoeren als <strong>Alie Smith</strong>, waarbij u zowel uw eigen gegevens beheert als de gegevens die <strong>Jane Doe</strong> met u heeft gedeeld.</p>

            <p>Probeer de taken zo nauwkeurig mogelijk uit te voeren. Onthoud: we <strong>testen de tool</strong>, niet u. Als iets verwarrend of moeilijk lijkt, is dat juist een heel belangrijk resultaat voor mijn onderzoek!</p>
        `
    };
