...
const tiers = { 0: { label: "Geen Policies", color: "grey" }, 1: { label: "Lezen", color: "green" }, 2: { label: "Toevoegen", color: "yellow" }, 3: { label: "Edit", color: "orange" }, 4: { label: "Admin", color: "red" } };
